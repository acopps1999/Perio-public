...
const PrismTitleSection = ({ className = "" }) => {
  ...
  const subtitleStyles = {
    ...
    opacity: 0.9,
    textShadow: isDarkMode ? '1px 1px 2px rgba(0, 0, 0, 0.3)' : '1px 1px 2px rgba(255, 255, 255, 0.3)',
    lineHeight: 1.2,
        ...
        {`
          ...
          .prism-app-background::before {
            ...
            background: ${isDarkMode ? `
              conic-gradient(from 0deg at 30% 40%,
                transparent 0deg,
                rgba(99, 102, 241, 0.15) 15deg,
                transparent 30deg,
                rgba(129, 140, 248, 0.12) 45deg,
                transparent 60deg,
                rgba(99, 102, 241, 0.25) 75deg,
                transparent 90deg
              ),
              conic-gradient(from 120deg at 70% 60%,
                transparent 0deg,
                rgba(99, 102, 241, 0.2) 20deg,
                transparent 40deg,
                rgba(165, 180, 252, 0.12) 60deg,
                transparent 80deg,
                rgba(129, 140, 248, 0.16) 100deg,
                transparent 120deg
              ),
              conic-gradient(from 240deg at 20% 80%,
                transparent 0deg,
                rgba(99, 102, 241, 0.28) 25deg,
                transparent 50deg,
                rgba(79, 70, 229, 0.16) 75deg,
                transparent 100deg
              ),
              radial-gradient(ellipse at 60% 20%,
              ...
              radial-gradient(ellipse at 15% 70%,
                rgba(165, 180, 252, 0.24) 0%,
                rgba(99, 102, 241, 0.08) 25%,
                transparent 50%
              )` : `
              conic-gradient(from 0deg at 30% 40%,
                transparent 0deg,
                rgba(79, 70, 229, 0.06) 15deg,
                transparent 30deg,
                rgba(99, 102, 241, 0.04) 45deg,
                transparent 60deg,
                rgba(79, 70, 229, 0.08) 75deg,
                transparent 90deg
              ),
              conic-gradient(from 120deg at 70% 60%,
                transparent 0deg,
                rgba(67, 56, 202, 0.07) 20deg,
                transparent 40deg,
                rgba(79, 70, 229, 0.04) 60deg,
                transparent 80deg,
                rgba(99, 102, 241, 0.06) 100deg,
                transparent 120deg
              ),
              conic-gradient(from 240deg at 20% 80%,
                transparent 0deg,
                rgba(79, 70, 229, 0.09) 25deg,
                transparent 50deg,
                rgba(67, 56, 202, 0.05) 75deg,
                transparent 100deg
              ),
              radial-gradient(ellipse at 60% 20%,
          ...
          .prism-app-background::after {
            ...
            background: ${isDarkMode ? `
              conic-gradient(from 60deg at 80% 30%,
                transparent 0deg,
                rgba(129, 140, 248, 0.2) 10deg,
                transparent 20deg,
                rgba(99, 102, 241, 0.16) 30deg,
                transparent 40deg,
                rgba(165, 180, 252, 0.12) 50deg,
                transparent 60deg
              ),
              conic-gradient(from 180deg at 25% 50%,
                transparent 0deg,
                rgba(129, 140, 248, 0.24) 30deg,
                transparent 60deg,
                rgba(99, 102, 241, 0.16) 90deg,
                transparent 120deg
              ),
              linear-gradient(45deg,
                transparent 0%,
                rgba(99, 102, 241, 0.08) 25%,
                transparent 50%,
                rgba(165, 180, 252, 0.12) 75%,
                transparent 100%
              ),
              linear-gradient(-30deg,
                transparent 0%,
                rgba(129, 140, 248, 0.16) 20%,
                transparent 40%,
              ...
              conic-gradient(from 60deg at 80% 30%,
                transparent 0deg,
                rgba(67, 56, 202, 0.07) 10deg,
                transparent 20deg,
                rgba(79, 70, 229, 0.05) 30deg,
                transparent 40deg,
                rgba(99, 102, 241, 0.04) 50deg,
                transparent 60deg
              ),
              conic-gradient(from 180deg at 25% 50%,
                transparent 0deg,
                ...
                transparent 60deg,
                rgba(79, 70, 229, 0.05) 90deg,
                transparent 120deg
              ),
              linear-gradient(45deg,
                transparent 0%,
                rgba(67, 56, 202, 0.03) 25%,
                transparent 50%,
